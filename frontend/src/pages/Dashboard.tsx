...
const recentTransactions = [
  { id: 1, description: "Grocery Store", amount: -85.30, category: "Groceries", date: "2024-01-15" },
  { id: 2, description: "Salary Deposit", amount: 3200.00, category: "Income", date: "2024-01-15" },
  { id: 3, description: "Netflix Subscription", amount: -15.99, category: "Entertainment", date: "2024-01-14" },
  { id: 4, description: "Gas Station", amount: -45.20, category: "Transportation", date: "2024-01-13" },
  { id: 5, description: "Electric Bill", amount: -120.50, category: "Utilities", date: "2024-01-12" }
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back! Here's your financial overview for January 2024.</p>
        </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>January 2024 spending progress</CardDescription>
              </div>
